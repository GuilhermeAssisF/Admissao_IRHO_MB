var Compartilhados = (function () {
  ...
  var getCacheDataSet = function (dataset, filter) {
    return cache[dataset] && cache[dataset][filter]
  ...
  var destacaParecer = function () {
    var new_span =
      '&nbsp;&nbsp;<span class="label label-warning">Cont&eacute;m Parecer</span>';
  ...
  var carregaDescricaoProcesso = function (codProcesso) {
    ...
    var descricao = DatasetFactory.getDataset(
      "processDefinition",
      ["processDescription"],
      [c1, c3]
    ).values[0].processDescription;
    $(".descricaoProcesso").html(descricao);
  };

  var expandePainel = function (atividade) {
    $("#panelAtividade_" + atividade)
      .collapse("show")
      .closest(".panel");
  };
  ...
  var getCodigoManual = function (codigoProcesso) {
    ...
    return DatasetFactory.getDataset(
      ...
      ["propertieValue"],
      [c1, c2, c3]
    ).values[0].propertieValue;
  };

  var carregaManual = function (codigoProcesso, targetElement) {
    var urlPrefix =
      "http://http://192.168.7.104:8080/portal/p/1/ecmnavigation?app_ecm_navigation_doc=";
  ...
  var validaCamposObrigatorio = function () {
    ...
    $("[obrigatorio]").each(function () {
      if ($(this).val() != "") {
        texto =
          "/nO campo " +
          $(this).closest(".form-group").find(".labelField").text() +
          " e obrigatório.";
      }
    });
  ...
  var getPhoneInformation = function (cpf) {
    ...
    var settings = {
      method: "GET",
      url:
        "https://direcional.telecomwm.com.br/api/pt-br/Telecom/Aparelho/" + cpf,
      headers: {
  ...
  var getCodProcess = function () {
    return window.parent.ecm_wkfview.processId == ""
      ? window.parent.ECM.workflowView.processId
      : window.parent.ecm_wkfview.processId;
  };
...
Compartilhados.dynamicallyLoadScript(
  "http://csc.direcional.com.br/compartilhados/scripts/vcXMLRPC.js"
);
